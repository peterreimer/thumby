h1. thumby
!https://travis-ci.com/hbz/thumby.svg?branch=master!:https://travis-ci.org/peterreimer/thumby

Thumby is a "district in germany":https://de.wikipedia.org/wiki/Thumby and a thumbnail generator as a web service. Pass an image or a pdf to the service and get a thumbnail image back.
...
p. Specify a location where thumby stores thumbnails
...
p. Go to http://localhost:9000/tools/thumby

h2. Manual Test

bc. curl -XGET "http://localhost:9000//tools/thumby?url=https://pbs.twimg.com/profile_images/2262780036/jan_128_400x400.jpg&size=200"
