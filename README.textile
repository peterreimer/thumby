...
bc.. wget http://downloads.typesafe.com/typesafe-activator/1.3.2/typesafe-activator-1.3.2-minimal.zip
unzip typesafe-activator-1.3.2-minimal.zip
mv activator-1.3.2-minimal /opt

h1. Run

bc.. git clone https://github.com/hbz/thumby
cd thumby
...
#Provide a comma separated list of servers to which thumby has access.  
thumby.whitelist="localhost,127.0.0.1"

p. edit startscript

bc.. sudo cp thumby/install/thumby.tmpl /etc/init.d
...
SECRET=`uuidgen` # generate a secret
